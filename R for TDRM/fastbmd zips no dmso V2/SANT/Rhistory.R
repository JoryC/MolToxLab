...
PerformDataAnnot("noAnn", "NA", "custom", "sum");
GetSummaryData()
PlotDataBox("qc_boxplot_4", "72", "png");
PlotDataPCA("qc_pca_4","72", "png", "NA");
PerformExpressNormalization("none", 0, 0,"noAnn");
PlotDataBox("qc_norm_boxplot_4", "72", "png");
PlotDataPCA("qc_norm_pca_4","72", "png", "NA");
qc.density("qc_norm_density_4","72", "png", "NA");
SetupDesignMatrix("limma");
PerformDEAnal("reference", "dose_0.0003");
GetSigGenes("Result_5", 0.05, 1.0,"false",2,"noAnn");
PlotMAPlot("ma_plot_7","72","png","0.05","1.0","2");
PlotVolcanoPlot("volcano_plot_7","72", "png", "0.05", "1.0" ,"2");
GetMetaColLength();
nrow(dataSet$sig.mat)
PrepareDataForDoseResponse();
GetSigDRItems( 0.05,1.0,"false","false", 0.05);
...
FilterDRFit();
PerformBMDCalc();
PlotDRModelBars("dr_barplot_4", 72, "png");
PlotDRHistogram("dr_histogram_5", 72, "png", "mg/kg", "log10");
ReadTabExpressData("raw.txt");
PerformDataAnnot("noAnn", "NA", "custom", "sum");
GetSummaryData()
PlotDataBox("qc_boxplot_5", "72", "png");
PlotDataPCA("qc_pca_5","72", "png", "NA");
PerformExpressNormalization("none", 0, 0,"noAnn");
PlotDataBox("qc_norm_boxplot_5", "72", "png");
PlotDataPCA("qc_norm_pca_5","72", "png", "NA");
qc.density("qc_norm_density_5","72", "png", "NA");
SetupDesignMatrix("limma");
PerformDEAnal("reference", "dose_0.0003");
GetSigGenes("Result_6", 0.05, 1.0,"false",2,"noAnn");
PlotMAPlot("ma_plot_8","72","png","0.05","1.0","2");
PlotVolcanoPlot("volcano_plot_8","72", "png", "0.05", "1.0" ,"2");
GetMetaColLength();
nrow(dataSet$sig.mat)
PrepareDataForDoseResponse();
GetSigDRItems( 0.05,1.0,"false","false", 0.05);
...
FilterDRFit();
PerformBMDCalc();
PlotDRModelBars("dr_barplot_5", 72, "png");
PlotDRHistogram("dr_histogram_6", 72, "png", "mg/kg", "log10");
