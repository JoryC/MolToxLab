...
multiplot(plotlist = histPlots, layout = matrix(c(1:length(histPlots)), nrow=2, byrow=FALSE))
...
multiplot(plotlist=reactomePlots, layout = matrix(c(1:length(reactomePlots)), nrow=2, byrow=FALSE))
...
multiplot(plotlist=goPlots, layout = matrix(c(1:length(goPlots)), nrow=2, byrow=FALSE))
