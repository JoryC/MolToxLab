...
#Import
go_raw_data <- raw_importer(file_path = "BMDExpressData_R-ODAF/GO_TERM/", 
                            file_type = ".txt", 
...
#Import
reactome_raw_data <- raw_importer(file_path = "BMDExpressData_R-ODAF/REACTOME/", 
                                     file_type = ".txt", 
                                     start_phrase = "GO/Pathway/Gene Set/Gene ID") %>%
...
BMD_raw_data <- list()
BMD_filenames <- list.files("BMDExpressData_R-ODAF/BMD", pattern = ".txt")
...
BMD_raw_data <- raw_importer(file_path = "BMDExpressData_R-ODAF/BMD/", 
                             file_type = ".txt", 
