...
#### load tPod Values ####
tPoD_values <- read.table(file = "BMDExpressData_R-ODAF/Output/tpod_values.txt", header = T)


#### BMD HISTOGRAM #####

# load BMD values for histograms 
raw_hist_data <- raw_importer(file_path = "BMDExpressData_R-ODAF/BMD/", 
                              file_type = ".txt", 
...
# import data
raw_reactome_data <- raw_importer(file_path = "BMDExpressData_R-ODAF/REACTOME/", 
                                                file_type = ".txt", 
...
raw_go_data <- raw_importer(file_path = "BMDExpressData_R-ODAF/GO_TERM/", 
                            file_type = ".txt", 
                            start_phrase = "GO/Pathway/Gene Set/Gene ID") %>%
...
write_csv(plyr::ldply(filtered_go_data), file = "All_Chemicals_GO_Data.csv")
write_csv(plyr::ldply(filtered_reactome_data), file = "All_Chemicals_Reactome_Data.csv")
write_csv(plyr::ldply(filtered_hist_data), file = "All_Chemicals_BMD_Data_for_Histogram.csv")  
