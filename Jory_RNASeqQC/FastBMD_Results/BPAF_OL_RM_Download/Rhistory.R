...
PerformExpressNormalization("logcount", 25, 10,"dre");
...
SetupDesignMatrix("limma");
PerformDEAnal("reference", "DOSE_0");
GetSigGenes("Result_2", 0.05, 0.0,"true",1,"dre");
PlotMAPlot("ma_plot_1","72","png","0.05","0.0","1");
PlotVolcanoPlot("volcano_plot_1","72", "png", "0.05", "0.0" ,"1");
GetMetaColLength();
nrow(dataSet$sig.mat)
SetupDesignMatrix("limma");
PerformDEAnal("reference", "DOSE_0");
GetSigGenes("Result_3", 0.05, 1.0,"false",1,"dre");
...
SetupDesignMatrix("limma");
PerformDEAnal("reference", "DOSE_0");
GetSigGenes("Result_4", 0.05, 1.5,"false",1,"dre");
PlotMAPlot("ma_plot_3","72","png","0.05","1.5","1");
PlotVolcanoPlot("volcano_plot_3","72", "png", "0.05", "1.5" ,"1");
GetMetaColLength();
nrow(dataSet$sig.mat)
SetupDesignMatrix("limma");
PerformDEAnal("reference", "DOSE_0");
GetSigGenes("Result_5", 0.05, 2.0,"false",1,"dre");
PlotMAPlot("ma_plot_4","72","png","0.05","2.0","1");
PlotVolcanoPlot("volcano_plot_4","72", "png", "0.05", "2.0" ,"1");
GetMetaColLength();
nrow(dataSet$sig.mat)
SetupDesignMatrix("limma");
PerformDEAnal("reference", "DOSE_0");
GetSigGenes("Result_6", 0.05, 2.5,"false",1,"dre");
PlotMAPlot("ma_plot_5","72","png","0.05","2.5","1");
PlotVolcanoPlot("volcano_plot_5","72", "png", "0.05", "2.5" ,"1");
GetMetaColLength();
nrow(dataSet$sig.mat)
SetupDesignMatrix("limma");
PerformDEAnal("reference", "DOSE_0");
GetSigGenes("Result_7", 0.05, 3.0,"false",1,"dre");
PlotMAPlot("ma_plot_6","72","png","0.05","3.0","1");
PlotVolcanoPlot("volcano_plot_6","72", "png", "0.05", "3.0" ,"1");
GetMetaColLength();
nrow(dataSet$sig.mat)
PrepareDataForDoseResponse();
GetSigDRItems( 0.05,3.0,"false","false", 0.05);
