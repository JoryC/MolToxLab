...
Tidy_Data %>%
  ...
  xlab("Theoretical") +
  theme_classic() +
  ggtitle("QQ plots showing approximattely non-normal distributions for each experiment
...
#This code was previously used to remove outliers using the Grubb's test. However, Grubb's test only works if the data are normally distributed./ However, it is not so Grubb;s test will not be applied
...
#Table shows mostly homogeneous variance except for vinclozilin, 4TOP and Aniline
