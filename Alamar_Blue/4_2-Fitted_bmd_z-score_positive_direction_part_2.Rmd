...
plot(p1_point$resp ~ p1_point$conc, pch = 16, axes=FALSE, frame.plot=TRUE, ylim=c(0, 6), ann=FALSE, col = "white")
#add title
title(main = chemicalNames[k])
#Build the X axis
Axis(side = 1, labels=print.numeric(unique(p1_point$x_label_num)), at = unique(p1_point$conc))
Axis(side = 2, labels = c(-1,0,1,2,3,4,5,6), at = c(-1,0,1,2,3,4,5,6))
#Build the Y axis
