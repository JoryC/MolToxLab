...
p_3 <- p_3 + geom_text(data = p_2_dat_lm, mapping = aes(label = lm, y = mean_y), x = 2.5, parse = TRUE, inherit.aes = FALSE, size = 2)

p_list <- list(p_1, p_2, p_3)
names(p_list) <- c("Outliers", "All Data", "Chemical Data")
```

```{r 27.1Monotonicity, echo = FALSE, results = 'asis'}
