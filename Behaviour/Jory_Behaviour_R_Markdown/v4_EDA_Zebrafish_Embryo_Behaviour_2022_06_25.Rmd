...
p_pearson_fitted <- ggplot(data = pearson_fitted$result$resp_set, aes(x = conc, y = fitted_resp)) +
  geom_smooth(data = pearson_fitted$result$resp_set, aes(x = conc, y = fitted_resp)) +
  geom_point(data = pearson_fitted$result$resp_set, aes(x = conc, y = resp)) +
  geom_vline(data = simulated_curve_bmds_pearson, aes(xintercept = POD_med), color = "blue") +
  geom_vline(data = simulated_curve_bmds_pearson, aes(xintercept = POD_cil), color = "green") +
    geom_hline(yintercept = -bmr_thresh_pearson, linetype = "dashed", color = "red") +
...
spearman_fitted <- simulated_curves_spearman %>%
  group_by(chemical) %>%
  run_fit(
  .,
  modls = c("hill", "cnst"),
...
p_spearman_fitted <- ggplot(data = spearman_fitted$result$resp_set, aes(x = conc, y = fitted_resp)) +
  geom_smooth() +
