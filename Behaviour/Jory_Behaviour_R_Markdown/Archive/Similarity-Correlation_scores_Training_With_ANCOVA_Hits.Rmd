...
#BMR of Pearson - 35
#BMR of Spearman - 35
#Active Pearson - 4TPP, ClofibricAcid, Fluoxetine, Vinclozolin
#Active Spearman - 1decanol, Fadrozole, ClofibricAcid, Fluoxetine, Prochloraz, Trenbolone

#Whole set of training data minus EE2, DMF and TEG
#BMR of Pearson - 35
#BMR of Spearman - 35
#Active Pearson - 4TPP, ClofibricAcid, Fluoxetine, Prochloraz
#Active Spearman - 1decanol, Fadrozole, ClofibricAcid, Fluoxetine, Prochloraz, Vinclozolin
train_set <- c("4TPP", "ClofibricAcid", "Fluoxetine", "Prochloraz", "Fadrozole", "Vinclozolin", "1decanol")

#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#

# train_set <- c("1octanol", "24DNP", "4TPP", "ClofibricAcid", "DES", "DMSO", "EE2", "Fadrozole", "Fenitrothion", "Fluoxetine", "Malathion", "Prochloraz", "Trenbolone")
...
# train_set <- c("ClofibricAcid", "Fluoxetine", "4TPP")
# #Only 'active' chemicals - Hit confidence > 0.5 (after training with entire data set AKA - BMR of 35 for both)
# #BMR of pearson - 35
# 
BMR_training_set_pearson <- simi_norm_tib_4rcurvep_pearson_no_extrm %>%
  filter(chemical %in% train_set) %>%
  filter(chemical == "Fadrozole") %>%
  select(endpoint, chemical, conc, resp)
# 
# train_set <- c("4TPP", "ClofibricAcid", "Fluoxetine", "Prochloraz", "Fadrozole", "Vinclozolin", "Trenbolone", "1decanol")
# #Only 'active' chemicals - Hit confidence > 0.5 (after training with entire data set AKA - BMR of 35 for both)
...
bmr_output_pearson <-
  estimate_dataset_bmr(BMR_training_set_act_pearson, plot = TRUE, p1 = 1, p2 = 19)
...
sum_bmd_dat_nobin_neg_pearson <- summarize_rcurvep_output(bmd_dat_nobin_neg_pearson, inactivate = c("U_SHAPE", "NOISY", "BLIP", "PART_U?"), ci_level = 0.95)
sum_bmd_dat_nobin_neg_spearman <- summarize_rcurvep_output(bmd_dat_nobin_neg_spearman, inactivate = c("U_SHAPE", "NOISY", "BLIP", "PART_U?"), ci_level = 0.95)
