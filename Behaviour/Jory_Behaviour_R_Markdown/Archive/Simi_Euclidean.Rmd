---
title: "Similarity Endpoint: Euclidean"
author: "Jory Curry"
...
\
The general workflow is to first, calculate similarity scores (Euclidean) for observations, normalize data to the median of control group, then perform statistical analyses and post-hoc tests (ANCOVA, Dunnett's test). Finally, a benchmark dose (BMD) is calculated for each chemical using the [Rcurvep package](https://github.com/moggces/Rcurvep).\
\
