...
sum_bmd_dat_nobin_neg_pearson <- summarize_rcurvep_output(bmd_dat_nobin_neg_pearson[[1]], inactivate = c("U_SHAPE", "NOISY", "BLIP", "PART_U?", "INVERSE"), ci_level = 0.95)
sum_bmd_dat_nobin_neg_spearman <- summarize_rcurvep_output(bmd_dat_nobin_neg_spearman[[1]], inactivate = c("U_SHAPE", "NOISY", "BLIP", "PART_U?", "INVERSE"), ci_level = 0.95)
