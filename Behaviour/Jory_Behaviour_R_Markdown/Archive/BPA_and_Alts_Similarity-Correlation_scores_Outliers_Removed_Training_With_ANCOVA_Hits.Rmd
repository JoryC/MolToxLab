...
I propose: instead of flagging active chemicals with an ANOVA (because we are violating normaility assumptions) we use an approach similar to the following (which the authors of the RcurveP package have done before):
...
```{r 10Distribution_of_concentrations, echo=FALSE}
