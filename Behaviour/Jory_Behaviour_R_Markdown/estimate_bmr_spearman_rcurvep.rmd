...
bmr_output_spearman <-
  estimate_dataset_bmr(BMR_training_set_act_spearman, plot = FALSE)
bmr_output_spearman_out <- bmr_output_spearman$outcome

plot(bmr_output_spearman)
```
...
saveRDS(object = bmr_thresh_spearman, file = paste0("Data/", params$endpoint, "_", params$method, "BMR.rds"))
saveRDS(object = input_spearman_tib, file = paste0("Data/", "input_spearman_tib.rds"))
```

```{r 59.2Clear_up_Memory_Before_moving_on_to_next_step, include=FALSE}
rm(BMR_training_set_act_spearman, BMR_training_set_act_spearman, bmr_output_spearman, bmr_output_spearman, bmr_output)
gc()
```